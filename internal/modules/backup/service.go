// Package backup produces TENANT-SCOPED logical exports of logistics's own data. A backup
...
import (
	...
	entbackup "github.com/bengobox/logistics-service/internal/ent/backup"
)
...
func (s *Service) Generate(ctx context.Context, tenantID uuid.UUID) (Info, error) {
	...
	name := fmt.Sprintf("logistics_backup_%s.json.gz", time.Now().UTC().Format("20060102_150405"))
