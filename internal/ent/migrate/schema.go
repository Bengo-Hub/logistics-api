...
var (
	...
	FleetsColumns = []*schema.Column{
		...
		{Name: "fleet_type", Type: field.TypeString, Default: "delivery"},
		{Name: "status", Type: field.TypeString, Default: "active"},
		{Name: "metadata", Type: field.TypeJSON},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
	...
	FleetMembersColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Default: "invited"},
		{Name: "invite_code", Type: field.TypeString, Unique: true, Nullable: true},
		{Name: "kyc_submitted_at", Type: field.TypeTime, Nullable: true},
		...
		{Name: "onboarding_source", Type: field.TypeString, Nullable: true, Default: "invite"},
	...
	VehiclesColumns = []*schema.Column{
		...
		{Name: "insurance_document", Type: field.TypeString, Nullable: true},
		{Name: "inspection_expiry", Type: field.TypeTime, Nullable: true},
		{Name: "inspection_document", Type: field.TypeString, Nullable: true},
		{Name: "metadata", Type: field.TypeJSON},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "fleet_id", Type: field.TypeUUID},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{VehiclesColumns[18]},
				RefColumns: []*schema.Column{FleetsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
