...
const (
	// Label holds the string label denoting the logisticsrole type in the database.
	Label = "logistics_role"
	...
	// Table holds the table name of the logisticsrole in the database.
	Table = "logistics_roles"
	...
	// PermissionsInverseTable is the table name for the LogisticsPermission entity.
	// It exists in this package in order to avoid circular dependency with the "logisticspermission" package.
	PermissionsInverseTable = "logistics_permissions"
	...
	UserAssignmentsColumn = "logistics_role_user_assignments"
...
// Columns holds all SQL columns for logisticsrole fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldRoleCode,
...
// OrderOption defines the ordering options for the LogisticsRole queries.
