...
func (_c *UserCreate) AddFleetMembershipIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddFleetMembershipIDs(ids...)
	return _c
}

// AddFleetMemberships adds the "fleet_memberships" edges to the FleetMember entity.
func (_c *UserCreate) AddFleetMemberships(v ...*FleetMember) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFleetMembershipIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.FleetMembershipsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
