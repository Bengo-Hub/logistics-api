...
type RolePermissionQuery struct {
	...
	withPermission *LogisticsPermissionQuery
...
func (_q *RolePermissionQuery) QueryRole() *LogisticsRoleQuery {
...
func (_q *RolePermissionQuery) QueryPermission() *LogisticsPermissionQuery {
...
func (_q *RolePermissionQuery) WithRole(opts ...func(*LogisticsRoleQuery)) *RolePermissionQuery {
	query := (&LogisticsRoleClient{config: _q.config}).Query()
...
func (_q *RolePermissionQuery) WithPermission(opts ...func(*LogisticsPermissionQuery)) *RolePermissionQuery {
	query := (&LogisticsPermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RolePermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RolePermission, error) {
	...
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *RolePermission, e *LogisticsRole) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPermission; query != nil {
		if err := _q.loadPermission(ctx, query, nodes, nil,
			func(n *RolePermission, e *LogisticsPermission) { n.Edges.Permission = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RolePermissionQuery) loadRole(ctx context.Context, query *LogisticsRoleQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *LogisticsRole)) error {
...
func (_q *RolePermissionQuery) loadPermission(ctx context.Context, query *LogisticsPermissionQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *LogisticsPermission)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*RolePermission)
	for i := range nodes {
	...
	query.Where(logisticspermission.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
