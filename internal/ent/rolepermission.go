...
type RolePermissionEdges struct {
	...
	Permission *LogisticsPermission `json:"permission,omitempty"`
...
func (e RolePermissionEdges) RoleOrErr() (*LogisticsRole, error) {
	if e.Role != nil {
		return e.Role, nil
...
// was not loaded in eager-loading, or loaded but was not found.
func (e RolePermissionEdges) PermissionOrErr() (*LogisticsPermission, error) {
	if e.Permission != nil {
		return e.Permission, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: logisticspermission.Label}
	}
...
func (_m *RolePermission) QueryRole() *LogisticsRoleQuery {
...
func (_m *RolePermission) QueryPermission() *LogisticsPermissionQuery {
