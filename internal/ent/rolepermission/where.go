...
func HasRoleWith(preds ...predicate.LogisticsRole) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
		step := newRoleStep()
...
func HasPermissionWith(preds ...predicate.LogisticsPermission) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
