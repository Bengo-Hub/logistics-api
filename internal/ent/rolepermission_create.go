...
func (_c *RolePermissionCreate) SetRole(v *LogisticsRole) *RolePermissionCreate {
	return _c.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the LogisticsPermission entity.
func (_c *RolePermissionCreate) SetPermission(v *LogisticsPermission) *RolePermissionCreate {
