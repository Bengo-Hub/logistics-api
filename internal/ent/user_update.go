...
func (_u *UserUpdate) AddFleetMembershipIDs(ids ...uuid.UUID) *UserUpdate {
	_u.mutation.AddFleetMembershipIDs(ids...)
	return _u
}

// AddFleetMemberships adds the "fleet_memberships" edges to the FleetMember entity.
func (_u *UserUpdate) AddFleetMemberships(v ...*FleetMember) *UserUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddFleetMembershipIDs(ids...)
}
...
// ClearFleetMemberships clears all "fleet_memberships" edges to the FleetMember entity.
func (_u *UserUpdate) ClearFleetMemberships() *UserUpdate {
	_u.mutation.ClearFleetMemberships()
	return _u
}

// RemoveFleetMembershipIDs removes the "fleet_memberships" edge to FleetMember entities by IDs.
func (_u *UserUpdate) RemoveFleetMembershipIDs(ids ...uuid.UUID) *UserUpdate {
	_u.mutation.RemoveFleetMembershipIDs(ids...)
	return _u
}

// RemoveFleetMemberships removes "fleet_memberships" edges to FleetMember entities.
func (_u *UserUpdate) RemoveFleetMemberships(v ...*FleetMember) *UserUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveFleetMembershipIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.FleetMembershipsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.FleetMembershipsTable,
			Columns: []string{user.FleetMembershipsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedFleetMembershipsIDs(); len(nodes) > 0 && !_u.mutation.FleetMembershipsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.FleetMembershipsTable,
	...
	if nodes := _u.mutation.FleetMembershipsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.FleetMembershipsTable,
...
// AddFleetMembershipIDs adds the "fleet_memberships" edge to the FleetMember entity by IDs.
func (_u *UserUpdateOne) AddFleetMembershipIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.AddFleetMembershipIDs(ids...)
	return _u
}

// AddFleetMemberships adds the "fleet_memberships" edges to the FleetMember entity.
func (_u *UserUpdateOne) AddFleetMemberships(v ...*FleetMember) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFleetMemberships clears all "fleet_memberships" edges to the FleetMember entity.
func (_u *UserUpdateOne) ClearFleetMemberships() *UserUpdateOne {
	_u.mutation.ClearFleetMemberships()
	return _u
}

// RemoveFleetMembershipIDs removes the "fleet_memberships" edge to FleetMember entities by IDs.
func (_u *UserUpdateOne) RemoveFleetMembershipIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.RemoveFleetMembershipIDs(ids...)
	return _u
}

// RemoveFleetMemberships removes "fleet_memberships" edges to FleetMember entities.
func (_u *UserUpdateOne) RemoveFleetMemberships(v ...*FleetMember) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
