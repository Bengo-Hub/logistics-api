...
func (_u *TenantSyncEventUpdate) ClearTenantID() *TenantSyncEventUpdate {
...
func (_u *TenantSyncEventUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.TenantIDCleared() {
		_spec.ClearField(tenantsyncevent.FieldTenantID, field.TypeUUID)
	}
...
// ClearTenantID clears the value of the "tenant_id" field.
func (_u *TenantSyncEventUpdateOne) ClearTenantID() *TenantSyncEventUpdateOne {
	_u.mutation.ClearTenantID()
	return _u
}
