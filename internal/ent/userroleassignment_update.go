...
func (_u *UserRoleAssignmentUpdate) SetRole(v *LogisticsRole) *UserRoleAssignmentUpdate {
...
// SetRole sets the "role" edge to the LogisticsRole entity.
func (_u *UserRoleAssignmentUpdateOne) SetRole(v *LogisticsRole) *UserRoleAssignmentUpdateOne {
	return _u.SetRoleID(v.ID)
}
