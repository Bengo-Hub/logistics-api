...
type TaskQuery struct {
	...
	withSteps           *TaskStepQuery
	withEvents          *TaskEventQuery
...
func (_q *TaskQuery) QuerySteps() *TaskStepQuery {
...
func (_q *TaskQuery) QueryEvents() *TaskEventQuery {
	query := (&TaskEventClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *TaskQuery) QueryAssignments() *TaskAssignmentQuery {
...
func (_q *TaskQuery) QueryProofOfDelivery() *ProofOfDeliveryQuery {
	query := (&ProofOfDeliveryClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *TaskQuery) Clone() *TaskQuery {
	...
	return &TaskQuery{
		...
		withProofOfDelivery: _q.withProofOfDelivery.Clone(),
...
func (_q *TaskQuery) WithSteps(opts ...func(*TaskStepQuery)) *TaskQuery {
	query := (&TaskStepClient{config: _q.config}).Query()
...
func (_q *TaskQuery) WithEvents(opts ...func(*TaskEventQuery)) *TaskQuery {
	query := (&TaskEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TaskQuery) WithAssignments(opts ...func(*TaskAssignmentQuery)) *TaskQuery {
	query := (&TaskAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TaskQuery) WithProofOfDelivery(opts ...func(*ProofOfDeliveryQuery)) *TaskQuery {
	query := (&ProofOfDeliveryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withProofOfDelivery = query
	return _q
}
...
func (_q *TaskQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Task, error) {
	...
	if query := _q.withSteps; query != nil {
		if err := _q.loadSteps(ctx, query, nodes,
			func(n *Task) { n.Edges.Steps = []*TaskStep{} },
			func(n *Task, e *TaskStep) { n.Edges.Steps = append(n.Edges.Steps, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withEvents; query != nil {
		if err := _q.loadEvents(ctx, query, nodes,
			func(n *Task) { n.Edges.Events = []*TaskEvent{} },
			func(n *Task, e *TaskEvent) { n.Edges.Events = append(n.Edges.Events, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAssignments; query != nil {
		if err := _q.loadAssignments(ctx, query, nodes,
			func(n *Task) { n.Edges.Assignments = []*TaskAssignment{} },
			func(n *Task, e *TaskAssignment) { n.Edges.Assignments = append(n.Edges.Assignments, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProofOfDelivery; query != nil {
		if err := _q.loadProofOfDelivery(ctx, query, nodes, nil,
			func(n *Task, e *ProofOfDelivery) { n.Edges.ProofOfDelivery = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TaskQuery) loadSteps(ctx context.Context, query *TaskStepQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskStep)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(taskstep.FieldTaskID)
	}
	query.Where(predicate.TaskStep(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(task.StepsColumn), fks...))
	}))
...
func (_q *TaskQuery) loadEvents(ctx context.Context, query *TaskEventQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskEvent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(taskevent.FieldTaskID)
	}
	query.Where(predicate.TaskEvent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(task.EventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TaskQuery) loadAssignments(ctx context.Context, query *TaskAssignmentQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskAssignment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(taskassignment.FieldTaskID)
	}
	query.Where(predicate.TaskAssignment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(task.AssignmentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TaskQuery) loadProofOfDelivery(ctx context.Context, query *ProofOfDeliveryQuery, nodes []*Task, init func(*Task), assign func(*Task, *ProofOfDelivery)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Task)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(proofofdelivery.FieldTaskID)
	}
	query.Where(predicate.ProofOfDelivery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(task.ProofOfDeliveryColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
