...
const (
	// Label holds the string label denoting the logisticspermission type in the database.
	Label = "logistics_permission"
	...
	// Table holds the table name of the logisticspermission in the database.
	Table = "logistics_permissions"
	// RolesTable is the table that holds the roles relation/edge. The primary key declared below.
	RolesTable = "role_permissions"
	// RolesInverseTable is the table name for the LogisticsRole entity.
	// It exists in this package in order to avoid circular dependency with the "logisticsrole" package.
	RolesInverseTable = "logistics_roles"
...
// Columns holds all SQL columns for logisticspermission fields.
var Columns = []string{
	FieldID,
	FieldPermissionCode,
	FieldName,
...
// OrderOption defines the ordering options for the LogisticsPermission queries.
