...
// SetRole sets the "role" edge to the LogisticsRole entity.
func (_u *RolePermissionUpdate) SetRole(v *LogisticsRole) *RolePermissionUpdate {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the LogisticsPermission entity.
func (_u *RolePermissionUpdate) SetPermission(v *LogisticsPermission) *RolePermissionUpdate {
...
// SetRole sets the "role" edge to the LogisticsRole entity.
func (_u *RolePermissionUpdateOne) SetRole(v *LogisticsRole) *RolePermissionUpdateOne {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the LogisticsPermission entity.
func (_u *RolePermissionUpdateOne) SetPermission(v *LogisticsPermission) *RolePermissionUpdateOne {
	return _u.SetPermissionID(v.ID)
}
